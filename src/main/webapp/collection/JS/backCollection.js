        ...
        let text = `
          <div class="container-fluid add" data-ID = ${findCollectuins[i].collectionID}>
            <div class="row d-flex  column">
              ...
              <div class="col-2">${findCollectuins[i].collectionTitle}</div>
              <div class="col-3" id="collectionTextLimit">${findCollectuins[i].collectionText}</div>
                ...
                <span class="icon">
                  ...
                  <span style="margin-left: 10px; margin-right:10px" class="icon" data-value="1">
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 24 24" width="25" height="25">
                      <path d="M5 18h14v2H5v-2zm4.6-2.7L5 10.7l2-1.9l2.6 2.6L17 4l2 2l-9.4 9.3z" fill="currentColor"></path>
                    </svg>
                  </span>
                </span>
              </div>
        ...
        let text = `
          <div class="container-fluid add" data-ID = ${collectionSerchEar[i].collectionID}>
            <div class="row d-flex  column">
              ...
              <div class="col-1"  style="text-align:center"> 
                <span class="icon" data-ID = ${collectionSerchEar[i].collectionID}>
                  <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 24 24"
                    width="25" height="25" class="fixed" data-ID = ${collectionSerchEar[i].collectionID}  data-TAG = ${collectionSerchEar[i].collectionMaterial}>
                    <g fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                      <path d="M9 7H6a2 2 0 0 0-2 2v9a2 2 0 0 0 2 2h9a2 2 0 0 0 2-2v-3"></path>
                      <path d="M9 15h3l8.5-8.5a1.5 1.5 0 0 0-3-3L9 12v3"></path>
                      <path d="M16 5l3 3"></path>
