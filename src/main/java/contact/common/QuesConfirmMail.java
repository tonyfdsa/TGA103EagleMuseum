...
//   		寄出email
	...
	private String quesConfirm = "謝謝您的提問，我們會盡快回覆。";


	public QuesConfirmMail(String mailAddress){
		this.mailAddress = mailAddress;
	}

	public void quesConfirmMail() {
		this.sendMail(mailAddress, subject, quesConfirm);
	}
