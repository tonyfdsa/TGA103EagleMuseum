...
public class CollectDaoSQL {
	...
	public static final String UPDATE = "UPDATE collection set collectionTitle=? ,collectionEar=? ,collectionText=?, collectionStatus=?, collectionMaterial=? where collectionID=? ";
}